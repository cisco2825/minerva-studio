...
export const SECTIONS: Section[] = [
    ...
    blocks: [
      ...
      { t: 'table',
        ...
        rows: [
          ...
          ['NOT', 'Negates condition',   'NOT applicant.city IN @blocked_cities'],
        ],
        codeCols: [0, 2],
      },
      { t: 'sub', s: 'Arithmetic' },
      ...
      { t: 'code', lines: [
        ...
        'applicant.city NOT IN @blocked_cities',
      ]},
  ...
  {
    id: 'lookups', num: '06', title: 'Lookup References ( @ )',
    blocks: [
      { t: 'text', s: "Lookup tables are CSV files managed in the Lookups section. Reference them in expressions with the @ prefix and the lookup's ID." },
      { t: 'code', lines: [
        'applicant.city     IN @cc_metro_cities',
        'applicant.employer NOT IN @cc_blocked_employers',
        'applicant.pincode  IN @approved_pincodes',
      ]},
      { t: 'bullets', items: [
        'Lookup IDs use underscores, not hyphens:  @cc_metro_cities  not  @cc-metro-cities',
        'The lookup must be in ACTIVE status to be available during evaluation.',
        'Lookups return a list — use them on the right-hand side of IN / NOT IN.',
      ]},
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      { t: 'code', lines: [
        ...
        'employer NOT IN @blocked_employers',
        '',
        '// ── Logic ────────────────────────────────────────',
  ...
  },
  {
    ...
    blocks: [
      { t: 'bullets', items: [
        ...
        'Lookup IDs use underscores:  @cc_metro_cities',
